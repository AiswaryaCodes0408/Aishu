      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          <div key={experience.id} className={`flex flex-col sm:flex-row items-center mb-16 ${ index % 2 === 0 ? 'sm:justify-end' : 'sm:justify-start' }`}>
            ...
            <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md transform transition-transform duration-300 hover:scale-105 ${
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex flex-col justify-between">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-semibold text-white">{experience.role}
                      </h3>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {experience.skills.map((skill, i) => (
                      <span key={i} className="bg-[#8245ec] text-gray-300 px-4 py-1 text-xs rounded-md" >{skill} </span>
                    ))}
                  </div>
                </div>
              </div>
