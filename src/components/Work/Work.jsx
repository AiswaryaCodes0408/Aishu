...
const Work = () => {
  return (
    <section id="work" className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative clip-path-custom-2 ">
          ...
          <div key={project.id} className="border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/50 hover:-translate-y-2 transition-transform duration-300" >
            ...
            <div className="p-6">
              ...
              <div className="mb-4 mt-5">
               ...
               <a href={project.webapp} target="_blank" rel="noopener noreferrer" className="text-purple-400 text-sm underline hover:text-purple-300 transition"> {project.webapp}</a>
            </div>
          </div>
        ))}
      </div>
